                ...
                <Grid container justify="center" alignItems="stretch">
                  ...
                  >
                    <p style={{ textAlign: "justify", margin: "5px" }}>
                      {" "}
                      En su cumpleaños, Ariel recibió muy{" "}
                      ...
                      <b>
                        ...
                        debe ser un auto a control remoto
                      </b>
                      ", pensó. Pero después de sacudir un poco el regalo notó
                      que éste no era para nada{" "}
                      <p id="h43" className={classes.h4}>
                        ??????
                      </p>
                      . <br />- "<b>Debe ser un muñeco de peluche!</b>", volvió
                      a pensar Ariel. <br />- "<b>Por qué no lo abrís, Ari?</b>
                      ", le dijo la mamá. "
                      <b>Que todavía tenés que abrir otros regalos</b>". <br />
                      Ariel abrió la tapa y{" "}
                      <p id="h44" className={classes.h4}>
                        ??????
                      </p>{" "}
                      vió que adentro se encontraba un oso grande{" "}
                      <p id="h45" className={classes.h4}>
                        ??????
                      </p>{" "}
                      de peluche como él tanto quería.
                    </p>
                  </Grid>
                  <Grid item xs={12} sm={12} md={6} style={{ margin: "auto" }}>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        ...
                        onClick={wordFunction("contento", "h41")}
                      >
                        contento
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("asustado", "h41")}
                      >
                        asustado
                      </li>
                    </ul>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        className={classes.words}
                        onClick={wordFunction("melancólico", "h42")}
                      >
                        melancólico
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("pesado", "h42")}
                      >
                        pesado
                      </li>
                    </ul>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        className={classes.words}
                        onClick={wordFunction("tranquilos", "h43")}
                      >
                        tranquilos
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("ruidoso", "h43")}
                      >
                        ruidoso
                      </li>
                    </ul>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        className={classes.words}
                        onClick={wordFunction("sorprendido", "h44")}
                      >
                        sorprendido
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("veloz", "h44")}
                      >
                        veloz
                      </li>
                    </ul>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        className={classes.words}
                        onClick={wordFunction("marrón", "h45")}
                      >
                        marrón
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("hiperactivo", "h45")}
                      >
                        hiperactivo
                      </li>
                    </ul>
