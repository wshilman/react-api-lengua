              ...
              <Card className={classes.card} style={{backgroundColor:"#FFCC80"}}>
                <Grid container justify="center" alignItems="stretch">
                  <Grid item xs={12} sm={12} md={6} style={{backgroundColor:"#FFF59D"}}> 
                    <p style={{textAlign:"justify", margin:"5px"}}> En su cumpleaños, Ariel recibió muy - - - - - - - -  su regalo. <br />
                      - "<b>Por lo - - - - - - debe ser un auto a control remoto</b>", pensó.
                      Pero después de sacudir un poco el regalo notó que éste no era para nada - - - - - - -. <br /> 
                      ...
                      Ariel abrió la tapa y - - - - - - - - - - - vió que adentro se encontraba un oso grande - - - - - - de peluche 
                      como él tanto quería. 
                    </p>
                  </Grid>
                  <Grid item xs={12} sm={12} md={6} style={{margin:"auto"}}> 
                    <ul className={classes.listas}>
                      <p className={classes.words} draggable="true"> MARRÓN </p> 
                      <p className={classes.words} draggable="true"> SORPRENDIDO </p> 
                    </ul>
                    <br />
                    <ul className={classes.listas}>
                      <p className={classes.words} draggable="true"> RUIDOSO </p> 
                      <p className={classes.words} draggable="true"> PESADO </p> 
                      <p className={classes.words} draggable="true"> CONTENTO </p> 
                    </ul>
                  </Grid>
                </Grid>
