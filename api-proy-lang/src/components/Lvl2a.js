                ...
                <Grid container justify="center" alignItems="stretch">
                  ...
                  >
                    <p style={{ textAlign: "justify", margin: "5px" }}>
                      ...
                      que vive en especialmente en los bosques o montañas de
                      América, aunque es muy{" "}
                      <p id="h42" className={classes.h4}>
                        ??????
                      </p>{" "}
                      y puede vivir en varias zonas diferentes. <br />
                      Pertenece a la familia de los félidos y puede ser tan{" "}
                      <p id="h43" className={classes.h4}>
                        ??????
                      </p>{" "}
                      como dos metros, sin incluir su cola. Es muy{" "}
                      <p id="h44" className={classes.h4}>
                        ??????
                      </p>{" "}
                      para trepar árboles y se refugia en ellos cuando se ve en
                      peligro. <br />
                      Este es un felino muy{" "}
                      <p id="h45" className={classes.h4}>
                        ??????
                      </p>
                      , se desplaza furtivamente y es el terror de los demás
                      animales. Aunque es un gran{" "}
                      <p id="h46" className={classes.h4}>
                        ??????
                      </p>
                      , no siempre es la especie dominante en su área. Se trata
                      de un felino{" "}
                      <p id="h47" className={classes.h4}>
                        ??????
                      </p>{" "}
                      que evita el contacto con las personas.
                    </p>
                  </Grid>
                  <Grid item xs={12} sm={12} md={6} style={{ margin: "auto" }}>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        ...
                        onClick={wordFunction("carnívoro", "h41")}
                      >
                        carnívoro
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("chiquito", "h41")}
                      >
                        chiquito
                      </li>
                    </ul>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        className={classes.words}
                        onClick={wordFunction("nadador", "h42")}
                      >
                        nadador
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("adaptable", "h42")}
                      >
                        adaptable
                      </li>
                    </ul>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        className={classes.words}
                        onClick={wordFunction("largo", "h43")}
                      >
                        largo
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("gordo", "h43")}
                      >
                        gordo
                      </li>
                    </ul>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        className={classes.words}
                        onClick={wordFunction("ágil", "h44")}
                      >
                        ágil
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("torpe", "h44")}
                      >
                        torpe
                      </li>
                    </ul>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        className={classes.words}
                        onClick={wordFunction("silencioso", "h45")}
                      >
                        silencioso
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("maullador", "h45")}
                      >
                        maullador
                      </li>
                    </ul>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        className={classes.words}
                        onClick={wordFunction("artista", "h46")}
                      >
                        artista
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("depredador", "h46")}
                      >
                        depredador
                      </li>
                    </ul>
                    <ul className={classes.listas2} style={{ margin: "12px" }}>
                      <li
                        className={classes.words}
                        onClick={wordFunction("tierno", "h47")}
                      >
                        tierno
                      </li>
                      <li
                        className={classes.words}
                        onClick={wordFunction("solitario", "h47")}
                      >
                        solitario
                      </li>
                    </ul>
